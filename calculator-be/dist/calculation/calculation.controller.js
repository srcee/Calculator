...
let CalculationController = class CalculationController {
    ...
    async createOne(createCalculationDto) {
...
], CalculationController.prototype, "getAll", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", Promise)
], CalculationController.prototype, "createOne", null);
CalculationController = __decorate([
